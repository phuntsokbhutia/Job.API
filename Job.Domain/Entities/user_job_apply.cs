...
namespace Job.Domain.Entities
{
    public class user_job_apply
    {
        ...
        // Foreign Key for User (linked to IdentityUser)
        ...
        public IdentityUser User { get; set; }  // Navigation property to IdentityUser (User)
        public job_details job_details { get; set; } // Navigation property to Job Details
